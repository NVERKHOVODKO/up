                ...
                <div className='inputFormPassword'>
                    ...
                    <div>
                        <input
                            ...
                            onBlur={(event) => {
                                handleSendRestoreCode(event);
                            }}
                        />
                        <button className='btnVerify' onClick={handleV}>Ok</button>
                        <button className='btnEditEmail' onClick={handleGetRestoreCode}>Получить код</button>
                    </div>
                    <div className='passwordContainer'>
                        <div className='inputPasswords'>
                            <input className='inputFieldEdit' type="password" placeholder="Введите пароль"
                                   value={password}
                                   onChange={(event) => setPassword(event.target.value)}/>
                            <input className='inputFieldEdit' type="password" placeholder="Повторите пароль"
                    ...
                    <div className='errorLbl'>
                        <h3 className="errorText">{errorMessagePass}</h3>
                    </div>
                </div>
            </div>
        </div>
